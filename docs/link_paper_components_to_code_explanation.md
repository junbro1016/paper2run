...
```bash
python3 scripts/link_paper_components_to_code.py <paper2run_json> <github_repo_url>
```

예시:

```bash
python3 scripts/link_paper_components_to_code.py Transformer_paper2run.json https://github.com/tensorflow/tensor2tensor
```
...
```bash
python3 scripts/link_paper_components_to_code.py Transformer_paper2run.json https://github.com/tensorflow/tensor2tensor --model gpt-4.1
```

### Equation만 매핑

```bash
python3 scripts/link_paper_components_to_code.py Transformer_paper2run.json https://github.com/tensorflow/tensor2tensor --equations-only
```

### 후보 snippet도 결과에 저장

```bash
python3 scripts/link_paper_components_to_code.py Transformer_paper2run.json https://github.com/tensorflow/tensor2tensor --save-candidates
```
